...
(function() {
  var LeaveForm, LeaveSystem, Node, People, a, a1, a2, a3, b, b1, b2, b3, c1, c2, c3, genFID, system, top;
  ...
  genFID = function(name) {
    ...
    month = dt.getMonth() + 1;
    day = dt.getDate();
    fID = year + "" + month + "" + day + "-" + req.body.name;
    return fID;
  };

  console.log(genFID("dfd"));
