...
(function() {
  $(document).ready(function() {
    var ImageFactory, checkForm, dButtonID, delay, pButtonID, printDayToForm, printImgtoForm, printTextToForm, sButtonID, saveFormToImg, saveImgtoServer, showMark, ssButtonID;
    $("#Form").hide();
