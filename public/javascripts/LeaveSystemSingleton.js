...
(function() {
  var LeaveForm, LeaveSystem, LeaveSystemSingleton, Node, People, clone, db, dbUrl, emptyFunction, genHT_of_Tree, mongoose;
  ...
  db.once('open', function() {
    return console.log("Leave System connect to database");
  });
  ...
  LeaveSystemSingleton = (function() {
    ...
    LeaveSystemSingleton.buildTree = function(pList) {
      ...
      for (key in ref) {
        n = ref[key];
        if (n.value.boss !== "") {
          n.setParent(nList[n.value.boss]);
        }
      }
      return nList;
    };
